 ...
 */            (function(window, factory) {
    ...
    (() => {
                ...
                function setSpollerAction(e) {
                    ...
                    if (el.closest("summary") && el.closest("[data-spollers]").classList.contains("_spoller-init")) {
                        ...
                        if (!spollersBlock.querySelectorAll("._slide").length) {
                            ...
                            spollerBlock.classList.toggle("_spoller-open");
        ...
        const inputMasks = document.querySelectorAll("#tel");
        if (inputMasks.length) flsModules.inputmask = Inputmask("+380 (99) 999-99-99").mask(inputMasks);
        ...
        function initSliders() {
            if (document.querySelector(".awards__slider")) new swiper_core_Swiper(".awards__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".page__awards .swiper-button-prev",
                    nextEl: ".page__awards .swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.1,
            ...
            if (document.querySelector(".review__slider")) new swiper_core_Swiper(".review__slider", {
                ...
                speed: 800,
                navigation: {
                    prevEl: ".page__review .swiper-button-prev",
                    nextEl: ".page__review .swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.1,
        ...
        window.addEventListener("load", (function() {
            setTimeout((() => {
                const itemsBlocks = document.querySelectorAll("[data-iso-items]");
                if (itemsBlocks.length) itemsBlocks.forEach((item => {
                    new isotope(item, {
                        itemSelector: "[data-iso-item]",
                        percentPosition: true,
                        horiz: {
                            columnWidth: ".components__item",
                            gutter: 0
                        }
                    });
                }));
        ...
        da.init();
        const reviewBlock = document.querySelector(".review__slider");
        if (reviewBlock) reviewBlock.addEventListener("click", (function(e) {
        ...
        const productCounts = cart.querySelector(".cart__count span");
        document.addEventListener("click", addToCartVariants);
        function addToCartVariants(e) {
            const target = e.target;
            if (target.closest(".item-preorder__button")) {
                const variantsButton = target.closest(".item-preorder__button");
                if (!variantsButton.classList.contains("_hold")) {
                    variantsButton.classList.add("_hold");
                    variantsButton.classList.add("_fly");
                    const product = variantsButton.closest(".item-preorder");
                    const productImage = product.querySelector(".item-preorder__media");
                    ...
                    productImageFly.addEventListener("transitionend", (function() {
                        if (variantsButton.classList.contains("_fly")) {
                            productImageFly.remove();
                            variantsButton.classList.remove("_fly");
                            variantsButton.classList.remove("_hold");
        ...
        (g => {
            ...
            key: "AIzaSyAHvFTpajfhiQCCDUS_bwUrBmcJPqrr1mM",
            v: "beta"
        });
        let map;
        ...
        window.addEventListener("load", (function() {
            function addArrow() {
                ...
                const mainBlockHeigth = mainBlock.offsetHeight;
                window.addEventListener("scroll", (function(e) {
                    const scrollTop = window.scrollY;
                    if (scrollTop > mainBlockHeigth && !arrow.classList.contains("arrow-show")) arrow.classList.add("arrow-show"); else if (scrollTop < mainBlockHeigth && arrow.classList.contains("arrow-show")) arrow.classList.remove("arrow-show");
                }));
            }
            addArrow();
        }));
